...
import org.oddjob.resolve.types.Authentication;
import org.oddjob.resolve.types.Mirror;
import org.oddjob.resolve.types.Proxy;
...
public class ResolverSessionBuilder {
    ...
    private ResolverSessionBuilder(ResolverSessionProperties sessionProperties) {
        this.sessionProperties = Objects.requireNonNull(sessionProperties);
    }

    public static ResolverSessionBuilder from(ResolverSessionProperties sessionProperties) {
    ...
    private String getUserAgent(ResolverSessionProperties project) {
    ...
    static File getDefaultLocalRepoDir(ResolverSessionProperties project, Settings settings) {
